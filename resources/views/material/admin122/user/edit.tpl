				...
				<section class="content-inner margin-top-no">
					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								<div class="form-group form-group-label">
									<label class="floating-label" for="node_speedlimit">用户限速（Mbps）（0为不限制）</label>
									<input class="form-control" id="node_speedlimit" type="text" value="{$edit_user->node_speedlimit}">
								</div>
								<div class="form-group form-group-label">
									<label class="floating-label" for="node_connector">用户同时连接IP数（0为不限制）</label>
						...
						<div class="card-main">
							<div class="card-inner">
								<div class="form-group form-group-label">
									...
									<textarea class="form-control" id="forbidden_ip" rows="4">{$edit_user->get_forbidden_ip()}</textarea>
								</div>
								<div class="form-group form-group-label">
									<label class="floating-label" for="node_speedlimit">禁止用户访问的端口，一行一个</label>
									<textarea class="form-control" id="forbidden_port" rows="4">{$edit_user->get_forbidden_port()}</textarea>
								</div>
							</div>
						</div>
					</div>
